...
main() {
    ...
    #eco ${DIR}/${PICS[$pic_index]} | sed -i '11 s/$.*//' Execs.conf
}
...
#swww query || swww init && swww img $HOME/Imágenes/Wallpapers/Dessert_light.jpg

#echo -e "[Theme]\nCurrent=catppuccin" | sudo tee -a "$sddm_conf_dir/10-theme.conf" 2>&1

#sed -i '11s/swww//' ~/hypramigo/config/hypr/sources/Execs.conf
