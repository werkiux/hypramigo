...
set -x
# Define the path
wallpaper_path="$HOME/Imágenes/Wallpapers/Dynamic-Wallpapers"
hypr_config_path="$HOME/.config"
...
ln -sf "${hypr_config_path}/dunst/styles/config-${next_mode}" "${hypr_config_path}/mako/config"
